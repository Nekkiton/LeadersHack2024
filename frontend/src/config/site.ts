export const Site = {
  ...
  defaultInviteMessage:
    'Добрый день! Меня зовут RECRUITER_NAME, я HR-менеджер RNT Group.\nУ нас есть открытая вакансия, которая может вас заинтересовать и мы хотели бы вас пригласить на собеседование по ней. Если вам актуально, назначьте удобное для вас время интервью при отклике на эту вакансию.\nБуду ждать обратной связи!',
}
